...
export async function getTeamMembers() {
  try {
    ...
    return [
      ...
      { name: "Arnav", role: "Business and Sales Supervisor", bio: "I am the engine of growth at N8E Labs. My focus is on identifying untapped market opportunities and closing the high-impact commercial deals that propel our regional innovations onto the global stage.", staticImage: withBase('/Arnav.jpeg') },
